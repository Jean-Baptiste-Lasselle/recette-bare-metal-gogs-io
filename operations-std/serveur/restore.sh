...
export NOM_CONTENEUR_DOCKER=conteneur-kytes.io.gitlab.$GOGS_INSTANCE_NUMBER
# ---------------------------------------
...
CONTENEUR_GOGS_MAPPING_HOTE_CONFIG_DIR=$REP_GIROFLE_CONTENEUR_DOCKER/config
CONTENEUR_GOGS_MAPPING_HOTE_DATA_DIR=$REP_GIROFLE_CONTENEUR_DOCKER/data
CONTENEUR_GOGS_MAPPING_HOTE_LOG_DIR=$REP_GIROFLE_CONTENEUR_DOCKER/logs
...
sudo rm -rf $CONTENEUR_GOGS_MAPPING_HOTE_CONFIG_DIR
sudo rm -rf $CONTENEUR_GOGS_MAPPING_HOTE_DATA_DIR
sudo rm -rf $CONTENEUR_GOGS_MAPPING_HOTE_LOG_DIR
...
sudo cp -Rf $REP_BCKUP_CHOISIT/$REP_BCKUP/config $CONTENEUR_GOGS_MAPPING_HOTE_CONFIG_DIR/*
sudo cp -Rf $REP_BCKUP_CHOISIT/$REP_BCKUP/log $CONTENEUR_GOGS_MAPPING_HOTE_LOG_DIR/*
sudo cp -Rf $REP_BCKUP_CHOISIT/$REP_BCKUP/data $CONTENEUR_GOGS_MAPPING_HOTE_DATA_DIR/*
