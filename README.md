...
echo " provision-gogsygirofle- Le backup Girafle a été cofniguré pour  " >> $NOMFICHIERLOG
echo " provision-gogsygirofle- s'exécuter automatiquent de la manière suivante: " >> $NOMFICHIERLOG
echo " provision-gogsygirofle-  " >> $NOMFICHIERLOG
crontab -l >> $NOMFICHIERLOG
echo " provision-gogsygirofle-  TERMINEE - " >> $NOMFICHIERLOG
